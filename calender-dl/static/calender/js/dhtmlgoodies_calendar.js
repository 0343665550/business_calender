...
var pathToImages = '/static/calender/images/';	// Relative to your HTML file
...
switch(languageCode){
	...
	case "en":	/* English */
		...
		var dayArray = ['Thứ 2','Thứ 3','Thứ 4','Thứ 5','Thứ 6','Thứ 7','Chủ nhật'];
...

{
	...
	yearPicker.style.left = '133px';

	yearPicker.style.top = monthDiv.offsetTop + monthDiv.offsetHeight + 1 + 'px';

	yearPicker.style.width = '55px';
